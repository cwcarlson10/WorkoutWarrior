...
Capstone Project Name: Workout Warrior
...
Objective: To create an application for personal trainers/coaches to set workouts for and follow up with clients to gauge client progress.

Description:
  The idea behind the project is to assist personal trainers or coaches in setting customized workouts for their clients so that the Trainer know better how to assist the clients.

It will give trainers the ability to set workouts for clients and then send the workout to the client and follow up to ensure program is completed. The client will be able to update their program and leave feedback for the trainer on how they did, any notes, etc.
...
Phase 2:
Routine Model
Create form that can be accessed by the Trainer to create a workout routine
Routines will be options for either muscle groups or exercises classes (i.e. legs, chest, shoulders or cardio, free weights, etc.)
form should have:
...
list of routines
Should be able to create a new routine and assign it to a client, or make it a generic
Should be able to add a new client
Client Model
Should be able to see current routines with the ability to:
Check routine as completed
leave comments about the routine
Should be able to see previous routines
